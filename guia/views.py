...
def procedures_list(request):
    ...
    base = [
        {"titulo":"Solicitar Férias","categoria":"ferias","descricao":"Como solicitar férias pelo SEI.","sei_url":"https://sei.exemplo.gov.br/processo/456"},
        {"titulo":"Afastamento por Motivo de Saúde","categoria":"afastamentos","descricao":"Passo a passo do afastamento médico.","sei_url":""},
        {"titulo":"Auxílio-Transporte","categoria":"beneficios","descricao":"Documentos e regras para concessão.","sei_url":"https://sei.exemplo.gov.br/processo/789"},
        {"titulo":"Nomeação e Posse","categoria":"admissao","descricao":"Fluxo de nomeação de servidores.","sei_url":""},
    ]
    itens = base
    if q:
    ...
    return render(request, "guia/procedures_list.html", {"procedimentos": itens, "q": q, "cat": cat})
